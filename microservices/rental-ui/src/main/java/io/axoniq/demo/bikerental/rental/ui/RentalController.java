...
//    public static final String FIND_ONE_QUERY = "findOne";
    ...
    private final KafkaPublisher<String, byte[]> publisher;
    // <.>
    //end::BusGateways[]

    private final BikeRentalDataGenerator bikeRentalDataGenerator;

    public RentalController(CommandGateway commandGateway, QueryGateway queryGateway, KafkaPublisher<String, byte[]> publisher, BikeRentalDataGenerator bikeRentalDataGenerator) { // <.>
